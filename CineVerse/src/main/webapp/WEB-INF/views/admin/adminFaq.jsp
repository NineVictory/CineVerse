...
<div class = "admin_member">
	<div class = "firstTitle">
		...
		<form action="adminFaq" id="admin_search">
			<ul>
				<li>
					<input type="hidden" name="keyfield" value="${param.keyfield != null ? param.keyfield : 'f_title'}"> <!-- 기본값 설정 -->
           			<input type="search" name="keyword" id="keyword" value="${param.keyword}" placeholder="을 입력하세요">
		...
		<div class="insert_button_all">
			<input type = "button" value = "FAQ 등록" class = "insert_button" onclick = "location.href ='${pageContext.request.contextPath}/admin/adminFaqForm'"/>
		</div>
        ...
        <tbody>
            <c:forEach var="faq" items="${list}">
                <tr>
                    ...
                    <td class="button2"><input type="button" value="삭제" onclick="deleteFaq(${faq.f_num})"/></td>
                </tr>
            </c:forEach>
        </tbody>
    </table>
