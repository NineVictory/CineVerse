...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/cboardFav.js"></script>
<!-- 나의 게시글 시작 -->
<div class="myPage_main">
    ...
    <c:if test="${count == 0}"><div class="empty_position">좋아요한 게시글이 없습니다.</div></c:if>
    <c:if test="${count > 0}">
    <!-- 반복 -->
