...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/movieReview.js"></script>
...
<div class="myPage_main">
    ...
    <!-- 반복 -->
    <c:if test="${count == 0}">
        <div class="empty_position">작성한 리뷰가 없습니다</div>
    </c:if>
    <c:if test="${count > 0}">
            ...
            <div class="review_box">
                <div class="review_content">
                    <div class="review_content_info">
                        ...
                        <div class="my_review" onclick="location.href='/movie/movieDetail?m_code=${rev.m_code}'">${rev.mr_content}</div>
                    </div>
                    <div class="review_delete_btn">
                        <input type="button" class="add_del_btn" data-num="${rev.mr_num}" data-mnum="${user.mem_num}" value="삭제">
                    </div>
                </div>
