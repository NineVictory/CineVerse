...
<div class="myPage_main">
    ...
    <c:forEach var="aboard" items="${list}">
        <div class="bookMark_box" onclick="location.href='${pagecontext.request.contextPath}/assignboard/detail?ab_num=${aboard.ab_num}'">
            <div class="bk_content">
                <div class="my_board_bk">
                    ...
                    <div class="my_boardWrite_bk">${aboard.ab_title}</div>
                </div>
            ...
            <div class="review_fav_date">
                <span>이미지</span> <span>${aboard.fav_cnt}</span> | 
                <span>
                    <c:choose>
