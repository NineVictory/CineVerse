                            ...
                            <c:forEach var="couponList" items="${couponList}">
                                <c:if test="${couponList.coupon_where==2 && couponList.coupon_use==1}">
                                    <div style="margin-left:15px; margin-top:20px; margin-bottom:0;">
                                        <input type="checkbox" class="single-select" name="option" value="${couponList.mc_num}" data-id="coupon-${couponList.mc_num}" data-num="${couponList.mc_num}" data-point="${couponList.coupon_sale}" data-nosaletotal="${total}">
                                    </div>
                                    <div class="coupon_detail" style="margin-top:0;" data-id="coupon-${couponList.mc_num}">
